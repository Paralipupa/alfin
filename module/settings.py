...
ENCONING = "utf-8"
PATT_NAME = r"(?:[А-ЯЁ][а-яё]+(?:-[А-ЯЁ][а-яё]+)?\s+){2}(?:[А-ЯЁ][а-яё]*(?:-[А-ЯЁ][а-яё]+)?)(?:вн?а|чна|вич|ьич|мич|глы|глу|гли|улу|ызы)"
...
PATT_DOG_DATE = "[0-9]{1,2}[.-][0-9]{2}[.-]20[0-9]{2}|^20[0-9]{2}[.-][0-9]{1,2}[0-9]{1,2}"
PATT_DOG_NUMBER = "(?:ON)?(?:[A-Z]{1}[0-9]{1}|[0-9]{1,2})[0-9]{4}20[123][0-9][0-9]{2}|20[123][0-9][0-9]{8}"
